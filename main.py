...
def onmessage(update,bot:ObigramClient):
    ...
    if '/start' in text:
        reply = '<a href="https://t.me/freenube">👋 NextCloudUploader 👋</a>\n\n'
        reply += 'Bot Para Descargar Archivos Desde Internet Directo A Tu NextCloud desarrollado por @Jose_PC98'
